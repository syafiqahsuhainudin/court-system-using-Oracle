                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li><a href="court.html">Court list</a></li>
            ...
            <div class="containers">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="register.jsp" class="signup-image-link">Create a member account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Login</h2>
                        <form method="get" action="loginadmin.jsp">
                            	<div class="form-group form-button">
                            		<input type="submit" name="failed" id="failed" class="form-submit" value="Wrong credentials. Click to log in again."/>
                            		</div>
