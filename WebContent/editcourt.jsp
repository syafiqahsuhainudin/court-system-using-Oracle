                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="editcourt.jsp">edit Court</a></li>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="mb-4">Court</h1>
          </div>
        </div>
      </div>
    </div>  

        <form method='post' id='emp-SaveForm' action="CourtController">
 
    <table class='table table-bordered' role="dialog" >
 
        <tr>
            <td>Court ID</td>
            <td><input type='text' name='courtid' class='form-control' value="<c:out value="${court.courtid}"/>" readonly/></td>
        </tr>
        <tr>
            <td>Court Type</td>
            <td><input type='text' name='courttype' class='form-control' value="<c:out value="${court.courttype}"/>" /></td>
        </tr>
        <tr>
            <td>Court Price</td>
            <td><input type='number' name='courtprice' class='form-control' value="<c:out value="${court.courtprice}"/>"></td>
        </tr>
 
        <tr>
            <td>Court Equipment</td>
            <td><input type='text' name='phoneno' class='form-control' value="<c:out value="${court.courtequipment}"/>"></td>
        </tr>
        
 		<tr>
            <td>Court Room</td>
            <td><input type='text' name='courtroom' class='form-control' value="<c:out value="${court.courtroom}"/>"></td>
        </tr>
        <tr>
            <td colspan="2">
