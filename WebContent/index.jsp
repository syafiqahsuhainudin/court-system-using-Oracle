      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="mb-4">Batu Berendam Sport Centre</h1>
            <p class="mb-5">May 5-13, 2019 &bullet; Melaka</p>
            <p class="regular-font-size">
              <a href="booking.jsp" class="btn btn-primary px-4 py-3 text-uppercase">Booking court Now</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 mx-auto text-left section-heading">
            <h2 class="mb-5 text-uppercase">About Batu Berendam Sports Center</h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-7">
            ...
            <p>At KSBB we strive to bring the best facilities of Futsal and Badminton with fair rates for you, your family and company

KSBB facilities comprise of 8 Futsal courts with Artificial Turf Grass and 23 Badminton courts that built to suite players needs. For further enquiries or booking, feel free to contact us.</p>
            <p class="mb-5">KSBB offers to a variety of events, tournament, friendly matches hosting. Any enquiries, please contact us. You can be our member to enjoy discount which only avalaible for member</p>
            
            
                  <form action="index.html">
                              
                              
                              <h2 class="mb-5 text-uppercase">Customer Detail</h2>
                                <!--== BOOKING DETAIL ==-->
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            <td>Customer IC</td>
            <td><c:out value="<%=custic%>"/></td>
        </tr>
        <tr>
         <td>Customer Phone</td>
            <td>   <c:out value="<%=contactnum%>"/> </td>
        </tr>
         <tr>
         <td>Address</td>
    ...
    <div class="site-block-half d-flex images">
      <div class="image bg-image" style="background-image: url('images/img_1.jpg');">
      </div>
      <div class="image bg-image" style="background-image: url('images/img_2.jpg');">
      </div>
    </div>
