<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="dbcourt.model.CourtBean, dbcourt.dao.CourtDAO, java.sql.*, java.util.*" %>
<!DOCTYPE html>
<html lang="en">
  <head>
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="admincourt.jsp">Court list</a></li>
  ...
  <table class="table table-bordered table-striped">
    ...
    <thead>
        ...
        <tbody>
			...
			<td align="center">
			<a id="" href="CourtController?action=edit&courtid=<%= p.getCourtid() %>" title="Edit">
			<img src="edit.png" width="20px" />
            </a></td>
			<td align="center"><a id="" href="CourtController?action=delete&courtid=<%= p.getCourtid() %>" title="Delete">
    ...
    <a href="CourtController?action=insert" class="btn btn-primary px-4 py-3 text-uppercase">Add Court</a>
