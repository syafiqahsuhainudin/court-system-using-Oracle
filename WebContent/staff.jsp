<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="dbcourt.model.StaffBean, dbcourt.dao.StaffDAO,dbcourt.controller.Logout, java.sql.*, java.util.*" %>
<!DOCTYPE html>
<html lang="en">
  <head>
        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.html">Sports Centre</a></h2><a href="Logout?action=logout" class="btn btn-primary px-4 py-3 text-uppercase">Logout</a>
              </div>
              <div class="col-10">
...
<% List<StaffBean> staffs = StaffDAO.getAllStaff();%>
  ...
  <table class="table table-bordered table-striped">
    ...
    <thead>
      ...
      <tr>
			...
			<td><%= p.getEmail() %></td>
			<td align="center">
			<a id="" href="StaffController?action=edit&staffid=<%= p.getStaffid() %>" title="Edit">
			<img src="edit.png" width="20px" />
            </a></td>
			<td align="center"><a id="" href="StaffController?action=delete&staffid=<%= p.getStaffid() %>" title="Delete">
  ...
  <a href="StaffController?action=insert" class="btn btn-primary px-4 py-3 text-uppercase">Add Staff</a>
