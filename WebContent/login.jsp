                    ...
                    <div class="signin-form">
                        ...
                        <form method ="get" action="logincontroller">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" placeholder="Your email" required oninvalid="this.setCustomValidity('Please Enter  email')"/>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="custpassword" id="custpassword" placeholder="Password"required oninvalid="this.setCustomValidity('Please Enter  Password')"/>
                            </div>
