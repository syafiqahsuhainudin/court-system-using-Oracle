...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.html">Confe.</a></h2>
              </div>
              <div class="col-10">
                  ...
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                          <li><a href="adminindex.jsp">Home</a>
						   ...
						   <li><a href="bookingdetails.jsp">Booking Detail</a></li>
						  <li><a href="staff.jsp">Staff</a></li>
						    <li  class="active"><a href="addstaff.jsp">Add Staff</a></li>
    ...
    <table class='table table-bordered' role="dialog" >
        ...
        <tr>
            <td>Staff Name</td>
            <td><input type='text' name='staffname' class='form-control' value='staffname' required></td>
        </tr>
 
        <tr>
            <td>Phone Number</td>
            <td><input type='text' name='phoneno' class='form-control' value='phoneno' required></td>
        </tr>
 
        <tr>
            <td>Manager ID</td>
            <td><input type='number' name='managerid' class='form-control' value='managerid' ></td>
        </tr>
 <tr>
            <td>Email</td>
            <td><input type='email' name='email' class='form-control' value='email' required></td>
        </tr>
