  ...
  <div class="site-wrap">
                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="addcourt.jsp">Add Court </a></li>
                    </ul>
                  </div>
                </nav>
              </div>
    ...
    <table class='table table-bordered' role="dialog" >
        ...
        <tr>
            ...
            <td><input type='text' name='courtequipment' class='form-control' value='courtequipment' ></td>
        </tr>
 <tr>
            <td>Court Room</td>
            <td><input type='text' name='courtroom' class='form-control' value='courtroom' required></td>
        </tr>
        <tr>
            <td colspan="2">
