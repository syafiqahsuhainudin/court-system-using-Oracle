                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="booking2.jsp">Booking court</a></li>
  ...
  <h1 class="mb-4">Booking </h1>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="login.jsp" method="post""p-5 bg-white">

           
			    <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="identity card">Identity Card</label>
                  <input type="text" id="custic" name="custic" class="form-control" placeholder="Identity Card"required>
                </div>
              </div>
   ...
   <a href="login.jsp" class="text-white">Continue Booking</a>
            </form>
          </div>
