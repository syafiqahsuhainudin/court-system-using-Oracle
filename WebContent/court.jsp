				 ...
				 <%	String custic = (String)session.getAttribute("currentSessionUserrr");%>
				  ...
				  <%	String address = (String)session.getAttribute("a");%>
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="court.jsp">Court list</a></li>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <table class='table table-bordered' role="dialog" >
        ...
        <tr>
            <td>IC Number</td>
            <td><input type='text' name='custic' class='form-control' value="<c:out value="<%=custic%>"/>" required></td>
        </tr>
   ...
   <tr>
        ...
        <tr>
            <td>Court ID</td>
            <td><input type='text' name='courtid' class='form-control'  required></td>
        </tr>
  ...
  <table class="table table-bordered table-striped">
    ...
    <thead>
        ...
        <tbody>
			...
			<td align="center">
			<a id="edit" class="edit-link" href="courtcontroller?action=update&courtid=<%= p.getCourtid() %>" title="Edit" >
