        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.jsp">Confe.</a></h2>
              </div>
              <div class="col-10">
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <div class="d-inline-block  ml-md-0 mr-auto py-3"><a href="#" class="site-menu-toggle js-menu-toggle"><span class="icon-menu h3"></span></a></div>
                     <!-- d-lg-block --> <%	String email = (String)session.getAttribute("currentSessionUser");%>
				 ...
				 <%	String custic = (String)session.getAttribute("currentSessionUserrr");%>
				  ...
				  <%	String address = (String)session.getAttribute("a");%>
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="bill.jsp">Bill</a></li>
...
<center><h1>.::Get Your total bill::.</h1></center>
<center><h4>Enter your Book id</h4></center>
<form method="post" action="billprocess.jsp">
<center>
<input type="text" name="search" required/>
<input type="submit" value="SEARCH"PLACEHOLDER=" Book id">
</center>
