...
%>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-10">
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">  <%	String email = (String)session.getAttribute("currentSessionUser");%>
				 ...
				 <%	String custic = (String)session.getAttribute("currentSessionUserrr");%>
				  ...
				  <%	String address = (String)session.getAttribute("a");%>
                    ...
                    <ul class="site-menu js-clone-nav d-none">
                      ...
                      <li class="active"><a href="booking.jsp">Booking court</a></li>
  ...
  <h1 class="mb-4">Booking </h1>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="bookingcontroller" method="post">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="identity card">Identity Card</label>
                  <input type="text" id="custic" name="custic" class="form-control" value="<c:out value="<%=custic%>"/>"placeholder="Identity Card"required>
                </div>
              </div>
                ...
                <div class="col-md-12">
                  ...
                  <input type="date" id="date" name="booking_date" class="form-control" placeholder="Date"required>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="starttime">startTime</label>
	      ...
	      <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="endtime">endtimeTime</label>
                    <select class="custom-select" name="endtime">
				      ...
				      <option value="7pm">7pm</option>
				       <option value="7pm">7pm</option>
                                      <option value="9pm">9pm</option>
                                      <option value="10pm">10pm</option> </select>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Register" class="btn btn-primary px-4 py-2">
                </div>
              </div>

   <a href="court.html" class="text-white">Continue Booking</a>
            </form>
          </div>
...
<table>
<div align="center" width="800"><image src="header.png"></div>
</table>
...
<center><h1>.::Get Your Bookid::.</h1></center>
<center><h4>Enter your ic number</h4></center>
<form method="post" action="searchprocess.jsp">
<center>
<input type="text" name="search" required/>
<input type="submit" value="SEARCH"PLACEHOLDER="Enter your ic to get bookid">
</center>
<table cellpadding="0" align="center"><td><h1>---</h1></td></table>
